...
const IconLabel =({ icon, label }) => {
    return (
        <View style={{ alignItems: 'center' }}>
            ...
            />
            <Text style={{ marginTop:SIZES.baseN, color: COLORS.gray, ...FONTS.h3}}>{label}</Text>
        </View>
    )
}
const DestinationDetail = ({navigation}) => {
                ...
                <View style={{ flexDirection: 'row'}}>
                        ...
                        <View style={{marginTop: SIZES.radius }}>
                            <Text style={{color: COLORS.gray, ...FONTS.body3}}>
                                Ski Villa offers simple room with mountain view in front of ski hill to the Ski Resort
                            </Text>
                        </View>
            </View>
            <View
    ...
    <View style={{ flex: 1.5}}>
        <View style={{ flexDirection: 'row', marginTop: SIZES.baseN, paddingHorizontal:SIZES.padding * 2, justifyContent:'space-between'}}>
            <IconLabel
                icon={icons.villa}
                label="Villa"
            />
        ...
        <View style={{ marginTop: SIZES.baseN, paddingHorizontal: SIZES.padding}}>
            <Text style={{ ...FONTS.h2}}>About</Text>
            <Text style={{ marginTop: SIZES.radius, color: COLORS.gray, ...FONTS.body3 }}>
                Located at the Alps with an altitude of 1,702 meters. The ski area is the largest ski area in the world and known as the best place to ski. Many other facilities, such as fitness center, sauna steam room to star-rated restuarents.
            </Text>
        </View>
    </View>
