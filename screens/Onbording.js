       ...
       <SafeAreaView style={styles.container}>
           ...
           <View style={{ flex:1, alignItems: 'center', justifyContent: 'center'}}>
                <View style={{ alignItems:'center', marginHorizontal: SIZES.padding}}>
                    <Text style={{ ...FONTS.h1 }}>Delicious Mountain</Text>
                    <Text style={{ color: COLORS.gray, marginTop: SIZES.padding, textAlign:'center', ...FONTS.body3}}>Easy solution to buy for your travel, business trips, transportation, lodging and culinary.</Text>
